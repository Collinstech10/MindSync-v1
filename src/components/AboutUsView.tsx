...
const MEMBERS_DATA: GroupMember[] = [
  ...
  },
  {
    ...
    contribution: "Crafted the optimal prompt sequence and managed edits in the Google AI Studio environment.",
  ...
  },
  {
    ...
    contribution: "He supervised the entire project and ensure tasks were assigned and completed by team members",
